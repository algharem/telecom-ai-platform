...
class KPIMetrics(BaseModel):
    ...
    All fields optional with defaults to support auto-fetching from data sources.
    """
    prb_usage: float
    throughput: float
    latency: float
